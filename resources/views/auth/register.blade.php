                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                            <ul class="tabs nav nav-tabs" id="myTab">
                                <li class="active"><a href="#tab1default" data-toggle="tab" id="prviTab">Registracija korisnika</a></li>
                                <li><a href="#tab2default" data-toggle="tab" id="drugiTab">Registracija vlasnika</a></li>
                                ...
                                <div class="tab-pane fade" id="tab2default">
                                    ...
                                    <div class="col-sm-12" id="content2">
                                        ...
                                        <div class="col-sm-12" align="center">
                                            <img id="slika1" alt="Slika" class="img-rounded"  width="250" height="250" @if(isset($takmicar['foto'])) src="{{$takmicar['foto']}}" @else src="/img/default/korisnik.jpg" @endif onclick="unesiFoto1()">
                                        ...
                                        <h3 align="center">Podaci o objektu</h3>
                                            ...
                                            <div class="col-sm-2 ">{!! Form::label('grad_id',"Grad", ['class'=>'col-md-4 control-label']) !!}</div>
                                            <div class="col-md-10 form-group">{!!Form::select('grad_id',$gradovi,1,['class'=>'form-control'])!!}</div>

                                            <div class="col-sm-2 ">{!! Form::label('vrsta_objekta_id',"Vrsta objekta", ['class'=>'col-md-4 control-label']) !!}</div>
